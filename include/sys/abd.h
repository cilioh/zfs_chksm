...
int jw_abd_iterate_func(abd_t *, size_t, size_t, abd_iter_func_t *, void *);
...
void jw_abd_copy_to_buf_off(void *, abd_t *, size_t, size_t);
...
static inline void
jw_abd_copy_to_buf(void* buf, abd_t *abd, size_t size)
{
	jw_abd_copy_to_buf_off(buf, abd, 0, size);
}
