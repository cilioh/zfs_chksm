...
//JW
	...
	printk(KERN_ERR "[zio_checksum_generate_chksm] time:%llu count:%llu\n", ee_t1, ee_c1);
	...
	printk(KERN_ERR "====================\n");
	printk(KERN_ERR "[chksm_overhead_disp] time:%llu count:%llu\n", chk_t, chk_c);
	printk(KERN_ERR "[chksm_overhead_read] time:%llu count:%llu\n", chk_t_1, chk_c_1);
