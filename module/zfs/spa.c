...
//JW
#define ZTI_BATCH_CHKSM { ZTI_MODE_BATCH_CHKSM, 0, 1 }
...
const zio_taskq_info_t zio_taskqs[ZIO_TYPES][ZIO_TASKQ_TYPES] = {
	// ISSUE	ISSUE_HIGH	INTR		INTR_HIGH 	CHKSM
	{ ZTI_ONE,	ZTI_NULL,	ZTI_ONE,	ZTI_NULL,	ZTI_ONE }, // NULL 
	{ ZTI_N(8),	ZTI_NULL,	ZTI_P(12, 8),	ZTI_NULL,	ZTI_ONE }, // READ 
	{ ZTI_BATCH,	ZTI_N(5),	ZTI_P(12, 8),	ZTI_N(5),	ZTI_BATCH_CHKSM }, // WRITE 
	{ ZTI_P(12, 8),	ZTI_NULL,	ZTI_ONE,	ZTI_NULL,	ZTI_ONE }, // FREE 
	{ ZTI_ONE,	ZTI_NULL,	ZTI_ONE,	ZTI_NULL,	ZTI_ONE }, // CLAIM 
	{ ZTI_ONE,	ZTI_NULL,	ZTI_ONE,	ZTI_NULL,	ZTI_ONE }, // IOCTL 
};
